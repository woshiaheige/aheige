  ...
  <div>
    ...
    >
      <template slot="status" slot-scope="status">
        ...
        <a-badge status="default" text="已关闭" v-show="status == 4" />
      </template>
    ...
    />
    <info-daily :visible.sync="visible" :detail="missionDetail"></info-daily>
  </div>
</template>
<script>
import infoDaily from "@/components/maintain/mission/info-daily";
