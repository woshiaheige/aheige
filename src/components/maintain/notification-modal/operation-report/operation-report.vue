    ...
    return {
      listData: {
        ...
        rows: [
          ...
          { 日期: "2020-5-2", 已完成: 1393, 未完成: 1093, 完成率: 0.32 },
          { 日期: "2020-5-3", 已完成: 3530, 未完成: 3230, 完成率: 0.26 },
          { 日期: "2020-5-4", 已完成: 2923, 未完成: 2623, 完成率: 0.76 },
          { 日期: "2020-5-5", 已完成: 1723, 未完成: 1423, 完成率: 0.49 },
          { 日期: "2020-5-6", 已完成: 3792, 未完成: 3492, 完成率: 0.323 },
          { 日期: "2020-5-7", 已完成: 4593, 未完成: 4293, 完成率: 0.78 }
        ]
      }
    };
  },
